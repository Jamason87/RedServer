module.exports = (req: any, res: any, next: any) => {
    ...
    res.header('access-control-allow-methods', 'GET, POST, PUT, DELETE', 'OPTIONS'); // Specifies the methods allowed when accessing the resource(or api) in the response preflight request.
